...

{
    ...
    fs_session("user2", "password3", &s, seq++);
    fs_session("user2", "password2", &s, seq++);
    fs_create("user1", "password1", session, seq++, "/dir/c", 'f');
    fs_create("user1", "password1", session, (seq-1), "/dir", 'd');
    fs_create("user1", "password1", session+2, seq++, "/dir", 'd');
    fs_create("user1", "password1", session, seq++, "/dir", 'd');
    fs_create("user1", "password1", session, seq++, "/dir", 'd');
    fs_create("user1", "password1", session, seq++, "/dir/file", 'f');
    fs_create("user1", "password1", session, seq++, "/dir/a", 'f');
    fs_create("user1", "password1", session, seq++, "/dir/b", 'f');
    fs_create("user1", "password1", session, seq++, "/dir/d", 'd');
