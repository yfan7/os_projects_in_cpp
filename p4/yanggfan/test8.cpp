...

{
    ...
    fs_create("reallylongusername", "password1", session, seq++, "/dir", 'd');
    --seq;
    fs_create("user1", "password1", session, seq++, "/dir/file", 'f');
    fs_create("user1", "wrongpassword", session, seq++, "/dir/file2", 'f');
    --seq;
    fs_create("user1", "password1", session, seq++, "/dir/file3", 'f');
    fs_create("nouser", "password1", session, seq++, "/dir/file4", 'f');
    --seq;
