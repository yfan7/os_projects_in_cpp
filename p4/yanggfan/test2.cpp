...

{
    ...
    fs_create("user1", "password2", session, seq++, "/dir", 'd');
    ...
    fs_writeblock("user1", "password1", session, seq++, "/dir/file", 125, writedata);

    fs_readblock("user1", "password1", session, seq++, "/dir/file", 125, readdata);
    for(int i = 0; i < 124; ++i) {
